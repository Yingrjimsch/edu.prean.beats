...
png("./edu.prean.beats/models/regression/spotify_songs_cleaned_with_trans_cook.png")
...
# Residual Plot
png("./edu.prean.beats/models/regression/spotify_songs_cleaned_with_trans_residuals.png")
