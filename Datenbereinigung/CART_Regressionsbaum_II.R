...
generateRegressionTree <- function(dataframe, splitfactor, target_var, scaling = TRUE, isTargetTransformed = TRUE, minSplitSequence, maxDepthSequence) {
  if(scaling){
...
result_with_trans_with_scaling <- generateRegressionTree(spotify_songs_cleaned_with_trans, 0.80, "streams", scaling = TRUE, isTargetTransformed = TRUE, minSplitSequence = seq(20, 100, 10), maxDepthSequence = seq(4, 10, 1))
...
result_with_trans_without_scaling <- generateRegressionTree(spotify_songs_cleaned_with_trans, 0.80, "streams", scaling = FALSE, isTargetTransformed = TRUE, minSplitSequence = seq(20, 100, 10), maxDepthSequence = seq(4, 10, 1))
...
result_with_trans_optima_with_scaling <- generateRegressionTree(spotify_songs_cleaned_with_trans_optima, 0.80, "streams", scaling = TRUE, isTargetTransformed = TRUE, minSplitSequence = seq(20, 100, 10), maxDepthSequence = seq(4, 10, 1))
...
result_with_trans_optima_without_scaling <- generateRegressionTree(spotify_songs_cleaned_with_trans_optima, 0.80, "streams", scaling = FALSE, isTargetTransformed = TRUE, minSplitSequence = seq(20, 100, 10), maxDepthSequence = seq(4, 10, 1))
...
result_without_trans_with_scaling <- generateRegressionTree(spotify_songs_cleaned_without_trans, 0.80, "streams", scaling = TRUE, isTargetTransformed = FALSE, minSplitSequence = seq(20, 100, 10), maxDepthSequence = seq(4, 10, 1))
...
result_without_trans_without_scaling <- generateRegressionTree(spotify_songs_cleaned_without_trans, 0.80, "streams", scaling = FALSE, isTargetTransformed = FALSE, minSplitSequence = seq(20, 100, 10), maxDepthSequence = seq(4, 10, 1))
